defmodule NPM.Security.SupplyChainTest do
  ...
  describe "assess" do
    test "computes assessment" do
      result = SupplyChain.assess(@pkg, @lockfile)
  ...
  describe "format" do
    test "formats assessment" do
      ...
      formatted = SupplyChain.format(assessment)
