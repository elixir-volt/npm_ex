defmodule NPM.Dependency.SortTest do
  ...
  describe "level_count" do
    test "counts levels" do
      count = Sort.level_count(@adj)
      assert count >= 3
    end

    test "single level for independent packages" do
      adj = %{"a" => [], "b" => [], "c" => []}
      assert 1 = Sort.level_count(adj)
    end
  end
end
