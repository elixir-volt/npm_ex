defmodule NPM.Resolution.ConditionalTest do
  ...
  describe "resolve" do
    ...
    test "resolves import condition" do
      entry = @exports["."]
      assert "./dist/esm/index.mjs" = Conditional.resolve(entry, ["import"])
    end

    test "resolves require condition" do
      entry = @exports["."]
      assert "./dist/cjs/index.js" = Conditional.resolve(entry, ["require"])
    end

    test "falls back to default" do
      entry = @exports["."]
      assert "./dist/cjs/index.js" = Conditional.resolve(entry, ["browser"])
    end

    test "nil for no match without default" do
      entry = %{"import" => "./esm.mjs"}
      assert nil == Conditional.resolve(entry, ["require"])
    end
    ...
    test "nested conditions" do
      ...
      assert "./dist/node-esm.mjs" = Conditional.resolve(entry, ["node", "import"])
    end
  end
  ...
  describe "conditions" do
    test "extracts all condition keys" do
      entry = @exports["."]
      conds = Conditional.conditions(entry)
    ...
    test "empty for string path" do
      assert [] = Conditional.conditions("./index.js")
    end
  end
  ...
  describe "uses_condition?" do
    test "true for used condition" do
      entry = @exports["."]
      assert Conditional.uses_condition?(entry, "import")
    end

    test "false for unused condition" do
      entry = @exports["."]
      refute Conditional.uses_condition?(entry, "browser")
    end
  end
